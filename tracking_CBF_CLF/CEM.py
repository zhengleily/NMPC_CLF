...
class CEMOptimizer(object):
    ...
    def setup(self, cost_function, tf_compatible=None):
    ...
    def obtain_solution(self, init_mean, init_var, cur_state, t0, agent):
        ...
        # while (t < self.max_iters):
            ...
            costs = self.cost_function(samples, cur_state, t0,agent)
